    ...
    return (
        <div>
            ...
            <div className='px-4 pt-24 pb-2 relative overflow-y-auto lg:ml-64'>
                ...
                <div id='1' className={disp === 0 ? 'block' : 'hidden'}>
                    {/* progress bar */}
                ...
                <div id='1' className={disp === 1 ? 'block' : 'hidden'}>
                    ...
                    <div className="w-full lg:w-6/12  px-4">
                        <div className="relative w-full mb-3">
                            <label
                                className={`text-lg  font-bold  ${color?.text} block mt-2  mb-2`}
                                htmlFor="grid-password">
                                Attractions
                    ...
                    <div key={0} className={`${color?.whitebackground} shadow rounded-lg px-12 sm:p-6 xl:p-8  2xl:col-span-2`}>
                        ...
                        {place?.attractions?.map((item, idx) => {
                            return (
                                <div key={idx} className='bg-white  mt-4 p-4 shadow divide-gray-200'>
